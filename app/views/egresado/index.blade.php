        ...
        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9">
                ...
                @if($post->tipo_post == '0')<!-- Caso post sin imagen -->
                 <div class="media">
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div><b><?php echo $dato1 ." ".$dato2 ." ".$dato3 ;?></b>
                            <!-- Menu Derecho -->
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        {{ Form::open(array('action' => 'ComentarioController@crear', 'files' => true)) }} 
                            ...
                            <div class="input-group">
                              {{ Form::textarea('feedbox', null, array('class' => 'form-control', 'id' => 'feedbox', 'placeholder' => 'Escribe tu comentario...', 'rows' => '1')) }}
                ...
                @else
                    ...
                    <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                        <div><div><b><?php echo $dato1 ." ".$dato2 ." ".$dato3 ;?></b>
                            <!-- Menu Derecho -->
                            @if(Auth::user()->tipo == '1' || Auth::user()->tipo == '2')
                            <!-- Los admin y encargados momentaneamente pueden editar de todos -->
                            <div class="dropdown pull-right">
